...
button_addsum = Button(root, text="+", padx=39, pady=20, command=button_add)
button_clear = Button(root, text="clear", padx=79, pady=20, command=button_clear)
button_equals = Button(root, text="=", padx=91, pady=20, command=button_equal)

button_subtract = Button(root, text="-", padx=39, pady=20, command=button_subtaction)
button_multiply = Button(root, text="x", padx=39, pady=20, command=button_multiplication)
...
button_addsum.grid(row=5, column=0)
